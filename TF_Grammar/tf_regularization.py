...
def what_regularization():
    ...
    sess.run(init_op)
    print("method 1 result:", sess.run(weight_loss_1))
    print("method 2 result:", sess.run(weight_loss_2))
    print("method 3 result:", sess.run(custom_weight_loss))


# ++++++++++++++++++++++++++++++++++++construct full connect layer+++++++++++++++++++++++++++++++++++++++
