...
def main():
    ...
    with tf.variable_scope("part_1"):
        ...
        # padding size is 2 along the height and width dimension
        # height_top = height_bottom = num_padding / 2 = 1
    ...
    with tf.Session(config=config) as sess:
        sess.run(init_op_1)
        # paddings == 'SAME'
        # output_size = np.ceil((input_size) / stride）= 3
        # output_size =
